...
void gui_widget_loginback_init(GUIwin *win, GUIwidget *widget)
{
    ...
    guiShaderUniform(program.loginBack, "r", 1f, 0.5f);
    guiShaderUniform(program.loginBack, "x", 1f, -WINDOW_WIDTH / 4);
    guiShaderUniform(program.loginBack, "y", 1f, WINDOW_HEIGHT / 4);
    guiShaderUniform(program.loginBack, "w", 1f, WINDOW_WIDTH / 2);
    guiShaderUniform(program.loginBack, "h", 1f, WINDOW_HEIGHT / 2);
