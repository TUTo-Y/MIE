...
void patientInit()
{
    ...
    guiWidgetButtonSetColor(GUI_ID_PATIENT_BUTTON_CHOICE_IMG, (vec4){0x02 / 255.0f, 0xAA / 255.0f, 0xB0 / 255.0f, 1.0f}, (vec4){0x00 / 255.0f, 0xCD / 255.0f, 0xAC / 255.0f, 1.0f});
    ...
    guiWidgetAddToControl(GUI_ID_WINDOW, GUI_ID_PATIENT_BUTTON_CHOICE_TXET, GUI_WIDGET_CALLFLAG_DRAW | GUI_WIDGET_CALLFLAG_EVENT_MOUSE_BUTTON | GUI_WIDGET_CALLFLAG_EVENT_CURSOR_POS,
                          800, 100, true);
    guiWidgetButtonSetText(GUI_ID_PATIENT_BUTTON_CHOICE_TXET, L"选择病历");
    guiWidgetButtonSetColor(GUI_ID_PATIENT_BUTTON_CHOICE_TXET, (vec4){0x02 / 255.0f, 0xAA / 255.0f, 0xB0 / 255.0f, 1.0f}, (vec4){0x00 / 255.0f, 0xCD / 255.0f, 0xAC / 255.0f, 1.0f});
    ...
    guiWidgetAddToControl(GUI_ID_WINDOW, GUI_ID_PATIENT_BUTTON_IMPLANT_TXET, GUI_WIDGET_CALLFLAG_DRAW | GUI_WIDGET_CALLFLAG_EVENT_MOUSE_BUTTON | GUI_WIDGET_CALLFLAG_EVENT_CURSOR_POS,
                          800, 100, true);
    guiWidgetButtonSetText(GUI_ID_PATIENT_BUTTON_IMPLANT_TXET, L"嵌入病历");
    guiWidgetButtonSetColor(GUI_ID_PATIENT_BUTTON_IMPLANT_TXET, (vec4){0x02 / 255.0f, 0xAA / 255.0f, 0xB0 / 255.0f, 1.0f}, (vec4){0x00 / 255.0f, 0xCD / 255.0f, 0xAC / 255.0f, 1.0f});
    ...
    guiWidgetButtonSetColor(GUI_ID_PATIENT_BUTTON_UPLOAD, (vec4){0xe5 / 255.0f, 0x2d / 255.0f, 0x27 / 255.0f, 1.0f}, (vec4){0xb3 / 255.0f, 0x12 / 255.0f, 0x17 / 255.0f, 1.0f});
    ...
    guiWidgetAddToControl(GUI_ID_WINDOW, GUI_ID_PATIENT_BUTTON_ALLOW, GUI_WIDGET_CALLFLAG_DRAW | GUI_WIDGET_CALLFLAG_EVENT_MOUSE_BUTTON | GUI_WIDGET_CALLFLAG_EVENT_CURSOR_POS,
                          800, 100, false);
    guiWidgetButtonSetText(GUI_ID_PATIENT_BUTTON_ALLOW, L"接受医生治疗");
    guiWidgetButtonSetColor(GUI_ID_PATIENT_BUTTON_ALLOW, (vec4){0x02 / 255.0f, 0xAA / 255.0f, 0xB0 / 255.0f, 1.0f}, (vec4){0x00 / 255.0f, 0xCD / 255.0f, 0xAC / 255.0f, 1.0f});
    ...
    guiWidgetAddToControl(GUI_ID_WINDOW, GUI_ID_PATIENT_BUTTON_REFUSE, GUI_WIDGET_CALLFLAG_DRAW | GUI_WIDGET_CALLFLAG_EVENT_MOUSE_BUTTON | GUI_WIDGET_CALLFLAG_EVENT_CURSOR_POS,
                          800, 100, false);
    guiWidgetButtonSetText(GUI_ID_PATIENT_BUTTON_REFUSE, L"取消");
    guiWidgetButtonSetColor(GUI_ID_PATIENT_BUTTON_REFUSE, (vec4){0xe5 / 255.0f, 0x2d / 255.0f, 0x27 / 255.0f, 1.0f}, (vec4){0xb3 / 255.0f, 0x12 / 255.0f, 0x17 / 255.0f, 1.0f});
    ...
    guiWidgetButtonSetColor(GUI_ID_PATIENT_BUTTON_RESULT, (vec4){0x02 / 255.0f, 0xAA / 255.0f, 0xB0 / 255.0f, 1.0f}, (vec4){0x00 / 255.0f, 0xCD / 255.0f, 0xAC / 255.0f, 1.0f});
